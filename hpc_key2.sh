...
if [[ $string == *"Permission denied"* ]]; then
	...
	string="{\"name\":\"demobycjz13\",\"project\":${project_id},\"type\":\"SLURM:SINGULARITY\",\"steps\":[{\"stepname\":\"hpcstep1\",\"dependency_policy\":\"AFTERANY\",\"command\":\"mkdir ~/c0001 ; sleep 1000; \",\"image\":\"${container_name}\",\"flavor\":${resource_pid},\"runs\":\"1\",\"volumes\":[{\"type\":\"HOSTPATH\",\"path\":\"/fs01\",\"mountPath\":\"/work/${account}\"},{\"type\":\"HOSTPATH\",\"path\":\"/fs02\",\"mountPath\":\"/home/${account}\"}]}]}"
	string="{\"name\":\"demobycjz14\",\"project\":${project_id},\"type\":\"SLURM:SINGULARITY\",\"steps\":[{\"stepname\":\"hpcstep1\",\"command\":\"mkdir ~/c0001 ; sleep 1000; \",\"image\":\"${container_name}\",\"flavor\":${resource_pid},\"runs\":\"1\",\"volumes\":[{\"type\":\"HOSTPATH\",\"path\":\"/fs01\",\"mountPath\":\"/work/${account}\"},{\"type\":\"HOSTPATH\",\"path\":\"/fs02\",\"mountPath\":\"/home/${account}\"}]}]}"
	string="{\"name\":\"demobycjz15\",\"project\":${project_id},\"type\":\"SLURM:SINGULARITY\",\"steps\":[{\"stepname\":\"hpcstep1\",\"command\":\"  echo $(date) >date.txt \",\"image\":\"${container_name}\",\"flavor\":${resource_pid},\"runs\":\"1\",\"volumes\":[{\"type\":\"HOSTPATH\",\"path\":\"/fs01\",\"mountPath\":\"/work/${account}\"},{\"type\":\"HOSTPATH\",\"path\":\"/fs02\",\"mountPath\":\"/home/${account}\"}]}]}"
